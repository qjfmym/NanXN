...
$(function () {
	...
	$.ajax({
		url : "${pageContext.request.contextPath}/admin?method=getdLgCount&number",
		type : 'post',
		success : function(date) {
			...
			for (var i = 0; i < arrays.length&&i<15; i++) {
				arraydata[i] = parseInt(arrays[i]);
			}
			/*图表开始 */
			 Highcharts.chart('container', {
			        title: {
			            text: '旅游网每日用户登录的数据展示图',
			            x: -20 //center
			        },
			        subtitle: {
			            text: '日人均访问量/人次',
